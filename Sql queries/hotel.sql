...
select * from login;
create table employee(name varchar(25), age varchar(3), gender varchar(15), job varchar(30), salary varchar(15), phone varchar(15), email varchar(40), aadhar varchar(20));
describe employee;
...
insert into department values('Kitchen or Food Production', '54000');
